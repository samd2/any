...
def main(ctx):
  ...
  linux_cxx("libc++", "clang++-8", packages="clang-8 libc++-8-dev libc++abi-8-dev", llvm_os="xenial", llvm_ver="8", buildtype="boost", buildscript="drone", image="cppalliance/droneubuntu1604:1", environment={'CXXFLAGS': '-stdlib=libc++', 'LINKFLAGS': '-stdlib=libc++', 'GCOVTOOL': 'gcov_for_clang.sh', 'TOOLSET': 'clang', 'COMPILER': 'clang++-8', 'CXXSTD': '03,11,14,17,20', 'DRONE_JOB_UUID': '1b64538924'}, globalenv=globalenv),
    ]
